...
// --- Scalar Math (Returns a single number) ---
...
// --- Vector Math (Returns a 1D vector) ---
std::vector<long double> vec_mean(const std::vector<std::vector<long double> > &data);

std::vector<long double> vec_std(const std::vector<std::vector<long double> > &data,
...
// --- Matrix Math (Returns a 2D vector) ---
...
std::vector<std::vector<long double> > matmul(const std::vector<std::vector<long double> > &A,
                                              const std::vector<std::vector<long double> > &B);

std::vector<std::vector<long double> > add(const std::vector<std::vector<long double> > &A,
                                           const std::vector<std::vector<long double> > &B);

std::vector<std::vector<long double> > subtract(const std::vector<std::vector<long double> > &A,
                                                const std::vector<std::vector<long double> > &B);
