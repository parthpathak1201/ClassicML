...
inline long double custom_exp(long double x) {
...
inline std::vector<std::vector<long double> > matinv(std::vector<std::vector<long double> > A) {
...
inline void docs(const std::string &func_name) {
